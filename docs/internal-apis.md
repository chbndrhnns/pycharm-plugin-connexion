...
- [ ] #Internal interface com.intellij.codeInsight.daemon.impl.IntentionMenuContributor reference
  ...
  com.github.chbndrhnns.intellijplatformplugincopy.features.intentions.suppressor.SuppressSuggestedRefactoringIntentionMenuContributor.
...
- [x] #Internal method com.intellij.util.SlowOperations.knownIssue(String) invocation
  ...
  com.github.chbndrhnns.intellijplatformplugincopy.features.intentions.customtype.CustomTypeApplier.startInlineRename$lambda$6(
...
- [x] #Internal method com.jetbrains.python.psi.PyImportElement.resolve() invocation
  ...
  com.github.chbndrhnns.intellijplatformplugincopy.core.psi.PyResolveUtils.findMember(PsiElement, String, boolean) :
  ...
  client code.
  Internal method com.jetbrains.python.psi.PyImportElement.resolve() : com.intellij.psi.PsiElement is invoked in
  com.github.chbndrhnns.intellijplatformplugincopy.features.intentions.populate.PyValueGenerator.generateClassTypeValue(
...
- [x] #Internal class com.jetbrains.python.psi.types.PyTypeUtil reference
  ...
  com.github.chbndrhnns.intellijplatformplugincopy.features.intentions.wrap.UnionCandidates.collectFromTypes(PyTypedElement,
...
- [x] #Internal class com.jetbrains.python.sdk.legacy.PythonSdkUtil reference
  ...
  com.github.chbndrhnns.intellijplatformplugincopy.core.services.PythonStdlibService.getStdlibModules(Sdk) : Set. This class
  is marked with @org.jetbrains.annotations.ApiStatus.Internal annotation or
  @com.intellij.openapi.util.IntellijInternalApi annotation and indicates that the class is not supposed to be used in
  client code.
  Internal class com.jetbrains.python.sdk.legacy.PythonSdkUtil is referenced in
  com.github.chbndrhnns.intellijplatformplugincopy.core.python.PythonVersionGuard.isSatisfied(Project) : boolean. This class
  is marked with @org.jetbrains.annotations.ApiStatus.Internal annotation or
  @com.intellij.openapi.util.IntellijInternalApi annotation and indicates that the class is not supposed to be used in
  client code.
...
- [x] #Internal method com.jetbrains.python.codeInsight.stdlib.PyStdlibTypeProvider.isCustomEnum(PyClass,
  ...
  com.github.chbndrhnns.intellijplatformplugincopy.features.intentions.customtype.TargetDetector.isEnumAssignment(PyExpression,
...
- [x] #Internal method com.jetbrains.python.sdk.legacy.PythonSdkUtil.findPythonSdk(Module) invocation
 ...
 com.github.chbndrhnns.intellijplatformplugincopy.core.python.PythonVersionGuard.isSatisfied(Project) : boolean. This method
 is marked with @org.jetbrains.annotations.ApiStatus.Internal annotation or
 @com.intellij.openapi.util.IntellijInternalApi annotation and indicates that the method is not supposed to be used in
 client code.
 Internal method com.jetbrains.python.sdk.legacy.PythonSdkUtil.findPythonSdk(com.intellij.openapi.module.Module
 module) : com.intellij.openapi.projectRoots.Sdk is invoked in
 com.github.chbndrhnns.intellijplatformplugincopy.core.services.PythonStdlibService.getStdlibModules(Sdk) : Set. This method
 is marked with @org.jetbrains.annotations.ApiStatus.Internal annotation or
 @com.intellij.openapi.util.IntellijInternalApi annotation and indicates that the method is not supposed to be used in
 client code.
...
- [x] #Internal method com.intellij.codeInsight.daemon.impl.DaemonCodeAnalyzerImpl.getHighlights(Document,
  ...
  com.github.chbndrhnns.intellijplatformplugincopy.features.intentions.IntroduceCustomTypeFromStdlibIntention.hasBlockingInspections(
