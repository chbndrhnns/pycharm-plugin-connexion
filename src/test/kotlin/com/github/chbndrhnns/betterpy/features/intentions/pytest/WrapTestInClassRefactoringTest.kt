...
class WrapTestInClassRefactoringTest : TestBase() {
    ...
    private val actionId =
        "com.github.chbndrhnns.betterpy.features.intentions.pytest.WrapTestInClassRefactoringAction"
    ...
    fun testNotAvailableWhenSettingDisabled() {
        val settings = com.github.chbndrhnns.betterpy.featureflags.PluginSettingsState.instance()
