...
import com.github.chbndrhnns.betterpy.features.inspections.PyMockPatchUnresolvedReferenceInspection
...
class PyMockPatchFQNQuickFixTest : TestBase() {
    ...
    fun testFQNQuickFixRespectsSourceRootPrefixDisabled() {
        ...
        // src is a source root
        runWithSourceRoots(listOf(myFixture.findFileInTempDir("src")!!)) {
            com.github.chbndrhnns.betterpy.featureflags.PluginSettingsState.instance().state.enableRestoreSourceRootPrefix =
                false
            try {
                myFixture.configureByText(
