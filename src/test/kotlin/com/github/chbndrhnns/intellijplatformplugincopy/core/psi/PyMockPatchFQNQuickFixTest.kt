...
import com.github.chbndrhnns.intellijplatformplugincopy.features.inspections.PyMockPatchUnresolvedReferenceInspection
...
class PyMockPatchFQNQuickFixTest : TestBase() {
    ...
    fun testFQNQuickFixRespectsSourceRootPrefixDisabled() {
        ...
        // src is a source root
        runWithSourceRoots(listOf(myFixture.findFileInTempDir("src")!!)) {
            com.github.chbndrhnns.intellijplatformplugincopy.featureflags.PluginSettingsState.instance().state.enableRestoreSourceRootPrefix =
                false
            try {
                myFixture.configureByText(
