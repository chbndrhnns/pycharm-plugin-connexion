...
import com.github.chbndrhnns.intellijplatformplugincopy.features.pytest.testtree.JumpToPytestNodeInTestTreeAction
...
class JumpToPytestNodeInTestTreeActionTest : TestBase() {
    ...
    fun testIsVisibleInTestFunctionBody() {
        ...
        val settings = com.github.chbndrhnns.intellijplatformplugincopy.featureflags.PluginSettingsState.instance().state
        ...
        assertTrue(
            ...
            com.github.chbndrhnns.intellijplatformplugincopy.features.pytest.testtree.PytestTestContextUtils.isInTestContext(
                elementAtCaret
            )
        )
    }
