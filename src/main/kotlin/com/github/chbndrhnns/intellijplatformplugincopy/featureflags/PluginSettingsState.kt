...
import com.github.chbndrhnns.intellijplatformplugincopy.features.refactoring.parameterobject.ParameterObjectFeatureSettings
...
class PluginSettingsState : PersistentStateComponent<PluginSettingsState.State> {
    data class State(
        ...
        @Feature(
            ...
            category = FeatureCategory.CODE_STRUCTURE,
            loggingCategories = [
                "com.github.chbndrhnns.intellijplatformplugincopy.features.intentions.AddSelfParameterIntention"
            ]
        )
        ...
        @Feature(
            ...
            category = FeatureCategory.PYTEST,
            loggingCategories = [
                "com.github.chbndrhnns.intellijplatformplugincopy.features.pytest.outcome.ReplaceExpectedWithActualIntention",
                "com.github.chbndrhnns.intellijplatformplugincopy.features.pytest.outcome.UseActualOutcomeUseCase",
                "com.github.chbndrhnns.intellijplatformplugincopy.features.pytest.outcome.TestOutcomeDiffService",
                "com.github.chbndrhnns.intellijplatformplugincopy.features.pytest.outcome.TestFailureListener"
            ]
        )
        ...
        @Feature(
            ...
            category = FeatureCategory.INSPECTIONS,
            loggingCategories = [
                "com.github.chbndrhnns.intellijplatformplugincopy.features.inspections.PyMockUnresolvedReferenceInspection"
            ]
        )
        ...
        @Feature(
            ...
            category = FeatureCategory.INSPECTIONS,
            loggingCategories = [
                "com.github.chbndrhnns.intellijplatformplugincopy.features.inspections.PyMockReturnAssignmentInspection"
            ]
        )
        ...
        @Feature(
            ...
            category = FeatureCategory.INSPECTIONS,
            loggingCategories = [
                "com.github.chbndrhnns.intellijplatformplugincopy.features.inspections.PyMockPatchObjectAttributeInspection"
            ]
        )
        ...
        @Feature(
            ...
            category = FeatureCategory.INSPECTIONS,
            loggingCategories = [
                "com.github.chbndrhnns.intellijplatformplugincopy.features.inspections.PyMockPatchUnresolvedReferenceInspection"
            ]
        )
        ...
        @Feature(
            ...
            category = FeatureCategory.COMPLETION,
            loggingCategories = [
                "com.github.chbndrhnns.intellijplatformplugincopy.features.completion.PyExpectedTypeCompletionContributor"
            ]
        )
        ...
        @Feature(
            ...
            category = FeatureCategory.COMPLETION,
            loggingCategories = [
                "com.github.chbndrhnns.intellijplatformplugincopy.features.completion.PyNamedArgumentFromScopeCompletionContributor"
            ]
        )
        ...
        @Feature(
            ...
            category = FeatureCategory.COMPLETION,
            loggingCategories = [
                "com.github.chbndrhnns.intellijplatformplugincopy.features.completion.PyMockPatchObjectAttributeCompletionContributor"
            ]
        )
        ...
        @Feature(
            ...
            category = FeatureCategory.COMPLETION,
            loggingCategories = [
                "com.github.chbndrhnns.intellijplatformplugincopy.core.psi.PyNewTypeTypeVarReferenceContributor"
            ]
        )
        ...
        @Feature(
            ...
            category = FeatureCategory.IMPORTS,
            loggingCategories = [
                "com.github.chbndrhnns.intellijplatformplugincopy.features.structureView.MyPythonStructureViewFactory",
                "com.github.chbndrhnns.intellijplatformplugincopy.features.structureView.MyStructureViewModelWrapper",
                "com.github.chbndrhnns.intellijplatformplugincopy.features.structureView.MyPrivateMembersFilter"
            ]
        )
        ...
        @Feature(
            ...
            loggingCategories = [
                "com.github.chbndrhnns.intellijplatformplugincopy.features.run.PyPackageRunLineMarkerContributor"
            ]
        )
        ...
        @Feature(
            ...
            loggingCategories = [
                "com.github.chbndrhnns.intellijplatformplugincopy.features.connexion.ConnexionPythonLineMarkerProvider",
                "com.github.chbndrhnns.intellijplatformplugincopy.features.connexion.ConnexionJsonLineMarkerProvider",
                "com.github.chbndrhnns.intellijplatformplugincopy.features.connexion.ConnexionYamlLineMarkerProvider"
            ]
        )
        ...
        @Feature(
            ...
            category = FeatureCategory.INSPECTIONS,
            loggingCategories = [
                "com.github.chbndrhnns.intellijplatformplugincopy.features.pytest.outcome.PyTestFailedLineInspection",
                "com.github.chbndrhnns.intellijplatformplugincopy.features.pytest.outcome.TestOutcomeDiffService",
                "com.github.chbndrhnns.intellijplatformplugincopy.features.pytest.outcome.TestFailureListener",
                "com.github.chbndrhnns.intellijplatformplugincopy.features.pytest.outcome.PytestLocationUrlFactory"
            ]
        )
