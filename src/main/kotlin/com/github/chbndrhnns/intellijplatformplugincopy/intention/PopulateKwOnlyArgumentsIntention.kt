...
/**
 * Intention that populates missing call arguments (including keyword-only
...
class PopulateKwOnlyArgumentsIntention : IntentionAction, HighPriorityAction, DumbAware, Iconable {
    ...
    override fun isAvailable(project: Project, editor: Editor, file: PsiFile): Boolean {
        if (!PluginSettingsState.instance().state.enablePopulateKwOnlyArgumentsIntention) {
            return false
        }
        ...
        text = "Populate missing arguments with '...'"
        return true
    }
