...
class PyInlineParameterObjectAction : AnAction() {
    override fun getActionUpdateThread(): ActionUpdateThread = ActionUpdateThread.BGT

    override fun update(e: AnActionEvent) {
        if (!PluginSettingsState.instance().state.enableInlineParameterObjectAction) {
        ...
        e.presentation.isEnabledAndVisible = InlineParameterObjectTarget.isAvailable(element)
    }
