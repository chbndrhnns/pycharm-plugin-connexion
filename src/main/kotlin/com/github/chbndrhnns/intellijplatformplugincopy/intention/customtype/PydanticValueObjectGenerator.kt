...
/**
 * Generator strategy for creating Pydantic value objects.
 *
 * Generates code like:
 * ```python
 ...
 */
class PydanticValueObjectGenerator : CustomTypeGeneratorStrategy {

    override val kind: CustomTypeKind = CustomTypeKind.PYDANTIC_VALUE_OBJECT
