package com.github.chbndrhnns.intellijplatformplugincopy.features.statusbar

import com.github.chbndrhnns.intellijplatformplugincopy.core.python.PythonVersionGuard
import com.github.chbndrhnns.intellijplatformplugincopy.featureflags.PluginSettingsConfigurable
...
class BetterPyStatusBarWidget(private val project: Project) : StatusBarWidget, StatusBarWidget.IconPresentation {
    ...
    private fun invokeCopyDiagnosticDataAction() {
        val action = ActionManager.getInstance()
            .getAction("com.github.chbndrhnns.intellijplatformplugincopy.features.actions.CopyDiagnosticDataAction")
        if (action != null) {
