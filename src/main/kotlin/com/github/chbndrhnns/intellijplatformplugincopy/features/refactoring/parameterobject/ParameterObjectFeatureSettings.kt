...
import com.github.chbndrhnns.intellijplatformplugincopy.featureflags.Feature
import com.github.chbndrhnns.intellijplatformplugincopy.featureflags.FeatureCategory
...
data class ParameterObjectFeatureSettings(
    @Feature(
        ...
        loggingCategories = [
            "com.github.chbndrhnns.intellijplatformplugincopy.features.refactoring.parameterobject",
        ],
        youtrackIssues = [
            "PY-59270",
        ]
