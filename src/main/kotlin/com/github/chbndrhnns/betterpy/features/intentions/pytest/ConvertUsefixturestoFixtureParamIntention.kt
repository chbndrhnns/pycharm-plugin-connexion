...
class ConvertUsefixturestoFixtureParamIntention : IntentionAction {

    override fun getText(): String = PluginConstants.ACTION_PREFIX + "Convert to fixture parameter"
    override fun getFamilyName(): String = "Convert usefixtures to fixture param"
    ...
    private fun findContext(file: PsiFile, editor: Editor): UsefixturesContext? {
        ...
        val fixtureName = stringLiteral?.stringValue ?: return null
